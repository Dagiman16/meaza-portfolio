  ...
  return (
    <div className="h-screen overflow-hidden bg-gray-100">
      ...
      >
        ...
        {/* Hero Section */}
        <section className="min-h-screen flex items-center justify-center bg-gradient-to-br from-orange-400 via-yellow-400 to-orange-500 relative overflow-hidden py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="text-white text-center lg:text-left order-2 lg:order-1">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                  <button 
                    ...
                    className="bg-white text-orange-500 px-6 sm:px-8 py-3 sm:py-4 rounded-full font-semibold hover:bg-orange-50 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1 cursor-pointer interactive-button"
                  >
                    Discover More
                  </button>
                  <a 
          ...
          <div className="absolute bottom-4 sm:bottom-8 left-1/2 transform -translate-x-1/2 text-white animate-bounce">
            <div className="flex flex-col items-center space-y-2">
              <span className="text-xs sm:text-sm text-orange-100">Scroll Down</span>
        ...
        {/* About Section */}
        <section className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 via-white to-indigo-50 relative py-20">
        ...
        <section className="min-h-screen flex items-center justify-center bg-gradient-to-br from-emerald-50 via-teal-50 to-cyan-50 relative overflow-hidden py-20">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-8 sm:mb-12">
        ...
        <section className="min-h-screen flex items-center justify-center bg-gradient-to-br from-amber-50 via-orange-50 to-yellow-50 relative overflow-hidden py-20">
          ...
          <div className="max-w-6xl mx-auto px-6 relative z-10">
            <div className="text-center mb-12">
              <div className="text-orange-500 text-sm uppercase tracking-wider mb-4 animate-fade-in">Professional Recognition</div>
              <h2 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-8 animate-slide-up">
                Achievements & Awards
              </h2>
            </div>
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="bg-gradient-to-br from-yellow-400 via-orange-500 to-red-500 rounded-3xl p-12 text-white relative overflow-hidden shadow-2xl animate-slide-up delay-200">
              ...
              <div className="space-y-6 animate-slide-up delay-400">
                <div className="bg-gradient-to-r from-blue-50 to-blue-100 rounded-2xl p-6 border-l-4 border-blue-500 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
                ...
                <div className="bg-gradient-to-r from-green-50 to-green-100 rounded-2xl p-6 border-l-4 border-green-500 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
                  <div className="flex items-center space-x-4">
                    <div className="text-3xl">📈</div>
                    <div>
                ...
                <div className="bg-gradient-to-r from-purple-50 to-purple-100 rounded-2xl p-6 border-l-4 border-purple-500 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
                  <div className="flex items-center space-x-4">
                    <div className="text-3xl">⭐</div>
                    <div>
        ...
        {/* Experience Section */}
        <section className="min-h-screen flex items-center justify-center bg-gradient-to-br from-purple-50 via-pink-50 to-rose-50 relative py-20">
          <div className="max-w-4xl mx-auto px-6 text-center">
            <div className="text-orange-500 text-sm uppercase tracking-wider mb-4 animate-fade-in">Professional Journey</div>
            <h2 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-12 animate-slide-up">
              Management Professional Experience
            </h2>
            
            <div className="bg-white rounded-3xl p-12 shadow-2xl relative overflow-hidden animate-slide-up delay-200">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-6">Strategic Leadership & Project Management</h3>
        ...
        <section className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-900 via-blue-900 to-indigo-900 text-white relative overflow-hidden py-20">
          ...
          <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
            <div className="text-blue-300 text-sm uppercase tracking-wider mb-4 animate-fade-in">Professional Contact</div>
            <h2 className="text-4xl lg:text-5xl font-bold mb-8 animate-slide-up">
              Let's Connect & Collaborate
            </h2>
            <p className="text-xl text-blue-100 mb-12 leading-relaxed animate-slide-up delay-200">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
              <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 hover:bg-white/20 transition-all duration-300 transform hover:-translate-y-2 animate-slide-up delay-300 cursor-pointer">
                ...
                <a href="mailto:meaza@example.com" className="text-blue-300 hover:text-white transition-colors text-sm">
                  meaza@example.com
                </a>
              </div>
              
              <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 hover:bg-white/20 transition-all duration-300 transform hover:-translate-y-2 animate-slide-up delay-400 cursor-pointer">
                ...
                <a href="tel:+251903183983" className="text-blue-300 hover:text-white transition-colors text-sm">
                  +251 903 183 983
                </a>
              </div>
              
              <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 hover:bg-white/20 transition-all duration-300 transform hover:-translate-y-2 animate-slide-up delay-500 cursor-pointer">
                <div className="w-16 h-16 bg-blue-400 rounded-full flex items-center justify-center mx-auto mb-4 shadow-lg">
                  <svg className="w-8 h-8 text-white" fill="currentColor" viewBox="0 0 24 24">
                ...
                <a href="https://t.me/Amhaye11" className="text-blue-300 hover:text-white transition-colors text-sm">
                  @Amhaye11
                </a>
              </div>
              
              <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 hover:bg-white/20 transition-all duration-300 transform hover:-translate-y-2 animate-slide-up delay-600 cursor-pointer">
                ...
                <a href="https://instagram.com/meaza_yimer" className="text-blue-300 hover:text-white transition-colors text-sm">
                  @meaza_yimer
                </a>
              </div>
            </div>
            
            <div className="flex flex-wrap justify-center gap-6 animate-slide-up delay-700">
              <a 
                href="/contact"
                className="bg-gradient-to-r from-orange-500 to-yellow-500 hover:from-orange-600 hover:to-yellow-600 text-white px-8 py-4 rounded-full font-semibold transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1 flex items-center space-x-2 cursor-pointer"
              >
              ...
              <a 
                href="/resume.pdf" 
                download="Meaza_Yimer_Resume.pdf"
                className="border-2 border-white text-white px-8 py-4 rounded-full font-semibold hover:bg-white hover:text-gray-900 transition-all duration-300 transform hover:-translate-y-1 flex items-center space-x-2 cursor-pointer"
              >
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <button 
                ...
                className="bg-white/10 backdrop-blur-sm text-white px-8 py-4 rounded-full font-semibold hover:bg-white/20 transition-all duration-300 transform hover:-translate-y-1 flex items-center space-x-2 cursor-pointer"
              >
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
